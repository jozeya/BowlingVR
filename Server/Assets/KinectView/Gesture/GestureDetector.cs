...
public class GestureDetector : IDisposable
{
    ...
    private readonly string leanDB = "GestureDB\\bowlingGesture.gbd";
            ...
            if (frame != null)
            {
                ...
                if (discreteResults != null)
                {
                    ...
                    foreach (Gesture gesture in this.vgbFrameSource.Gestures)
                    {
                        ...
                        if (gesture.Name.Equals(this.throwGestureName) && gesture.GestureType == GestureType.Discrete)
                        {
                            DiscreteGestureResult result = null;
                            discreteResults.TryGetValue(gesture, out result);
                            ...
                            if (result != null)
                            {
                                if (this.OnGestureDetected != null)
                                {
                                    this.OnGestureDetected(this, new GestureEventArgs(true, result.Detected, result.Confidence, this.throwGestureName));
                                }
                            }
                        }
